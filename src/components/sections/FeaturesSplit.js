          ...
          <div className={splitClasses}>
            ...
            <div className="split-item">
              <div className="split-item-content center-content-mobile reveal-from-left" data-reveal-container=".split-item">
                <div className="text-xxs text-color-primary fw-600 tt-u mb-8">
                  Overview of inference results
                  </div>
                <h3 className="mt-0 mb-12">
                  Dashboard
                  </h3>
                <p className="m-0">
                  The Dashboard is where you find what your AI solutions, <q>kernels</q>, have done with the information you have given them. In the case of the summarizer, here is where you get your summaries.  
                  </p>
              </div>
              <div className={
                classNames(
            ...
            <div className="split-item">
              <div className="split-item-content center-content-mobile reveal-from-right" data-reveal-container=".split-item">
                ...
                <p className="m-0">
                  Here is where you can search for and subscribe to your kernels.  
                  </p>
              </div>
              <div className={
                classNames(
